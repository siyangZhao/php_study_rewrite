...
if ($_POST)
{
	...
	if (strlen($content) > 10)
	{
									 ...
									 ]))
		{
		    ...
		    $_SESSION['errors']['details'] = ['帖子修改成功啦！'];
	...
	<?php include './includes/nav.php'; ?>
		<div class="am-g am-container php-bg-white  php-box-shadow am-padding-bottom">
			...
			<div class="am-u-lg-offset-1 am-u-lg-10 am-u-md-offset-1 am-u-md-10 am-u-sm-12 am-margin-top-xl">
				<form class="am-form" method="post" action="<?php echo $host_url;?>update_article.php">
					<div class="am-form-group am-form-icon">
					    <label for="title">主题：</label><!--<label>当用户选择该标签时，浏览器就会自动将焦点转到和标签相关的表单控件上
					                                           <label> 标签的 for 属性应当与相关元素的 id 属性相同-->
					    <input type="text" class="am-radius php-input" name="title" value="<?php echo $_SESSION['article']['title'] ?><?php echo session_read_post('title');?>" required>
				    </div>
				    <div class="am-form-group am-form-icon">
